...
document.getElementById('btn-participants').addEventListener('click', () =>{
    console.log('pressed now!');
    var partList = document.querySelector('#participant-list');
    var li;
    for(peerUsername in mapPeers){
        var participantName = peerUsername ;
    ...
    li = document.createElement('li');  
    li.append(document.createTextNode(username+"(You)"));
    partList.append(li);
});
...
function createVideo(peerUsername){
    ...
    var videoName = document.createTextNode(peerUsername);
